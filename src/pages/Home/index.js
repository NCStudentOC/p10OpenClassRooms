...
const Page = () => {
  const { last } = useData()
  // useData()  un hook personnalisé pour récupérer des données, 
  // des informations sur les événements, la dernière prestation, etc., utilisé via { last } = useData().

  // mais rien n'indique la gestion de last et du dernier evenenement à afficher en footer
  ...
  return <>
    ...
    <main>
      <section className="SliderContainer" >
        <Slider data-testid="testSlider, secondSlider" />
      </section>
      ...
      <section className="EventsContainer" id="nos-realisations">
        ...
        <EventList data-testid="testEventList" />
      </section>
    ...
    <footer className="row" data-testid="testFooter">
      <div className="col presta" data-testid="testLastEvent" >
